...
const Footer : React.FC = () => {
    return(
        <footer className="flex flex-col justify-center gap-10 mt-10 mb-10 items-center px-4">
            <div className="w-[90vw] h-[1px] bg-gray-300"></div>
            <section className="flex flex-col gap-2 sm:flex-row sm:justify-between sm:items-center w-[90vw] text-center sm:text-left">
